...
- Publish: 
```
  docker build -t owencio/easy_scraper:0.12.pre . && docker push owencio/easy_scraper:0.12.pre
  docker tag owencio/easy_scraper:0.12.1 owencio/easy_scraper:latest 
